...
- Working on this now. But the current task is to refactor away from
  Pedestal, since it's not adding anything given that I already have a
  Servlet implementation from JGit.
